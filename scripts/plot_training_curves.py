...
# Two-stage methods: concatenate with offset
...
# --- Loss ---
ax1.plot(s1_steps, s1_loss, "-", color="#90CAF9", label="AC-DPO (4+4ep)", linewidth=1.0, alpha=0.6)
ax1.plot(s2_steps, s2_loss, "-", color="#90CAF9", linewidth=1.0, alpha=0.6)
ax1.plot(v2s1_steps, v2s1_loss, "-", color="#D32F2F", label="AC-DPO v2 (2+6ep)", linewidth=1.5, alpha=0.9)
ax1.plot(v2s2_steps, v2s2_loss, "-", color="#D32F2F", linewidth=1.5, alpha=0.9)
ax1.plot(rs1_steps, rs1_loss, "-.", color="#FF9800", label="Reverse (hard→easy)", linewidth=1.0, alpha=0.7)
ax1.plot(rs2_steps, rs2_loss, "-.", color="#FF9800", linewidth=1.0, alpha=0.7)
ax1.plot(bl64_steps, bl64_loss, "--", color="#4CAF50", label="Baseline r=64", linewidth=1.0, alpha=0.7)
ax1.plot(bl8_steps, bl8_loss, ":", color="#9C27B0", label="Baseline r=8", linewidth=1.0, alpha=0.7)
# Stage transition markers
ax1.axvline(x=4000, color="gray", linewidth=0.7, linestyle="--", alpha=0.4)
ax1.axvline(x=2000, color="#D32F2F", linewidth=0.7, linestyle="--", alpha=0.3)
...
# --- Margin ---
ax2.plot(s1_steps, s1_margin, "-", color="#90CAF9", label="AC-DPO (4+4ep)", linewidth=1.0, alpha=0.6)
ax2.plot(s2_steps, s2_margin, "-", color="#90CAF9", linewidth=1.0, alpha=0.6)
ax2.plot(v2s1_steps, v2s1_margin, "-", color="#D32F2F", label="AC-DPO v2 (2+6ep)", linewidth=1.5, alpha=0.9)
ax2.plot(v2s2_steps, v2s2_margin, "-", color="#D32F2F", linewidth=1.5, alpha=0.9)
ax2.plot(rs1_steps, rs1_margin, "-.", color="#FF9800", label="Reverse (hard→easy)", linewidth=1.0, alpha=0.7)
ax2.plot(rs2_steps, rs2_margin, "-.", color="#FF9800", linewidth=1.0, alpha=0.7)
ax2.plot(bl64_steps, bl64_margin, "--", color="#4CAF50", label="Baseline r=64", linewidth=1.0, alpha=0.7)
ax2.plot(bl8_steps, bl8_margin, ":", color="#9C27B0", label="Baseline r=8", linewidth=1.0, alpha=0.7)
ax2.axhline(y=0, color="gray", linewidth=0.5, linestyle="--")
ax2.axvline(x=4000, color="gray", linewidth=0.7, linestyle="--", alpha=0.4)
ax2.axvline(x=2000, color="#D32F2F", linewidth=0.7, linestyle="--", alpha=0.3)
