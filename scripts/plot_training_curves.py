...
# --- Loss ---
ax1.plot(s1_steps, s1_loss, "-", color="#2196F3", label="AC-DPO (easy→hard)", linewidth=1.3, alpha=0.9)
ax1.plot(s2_steps, s2_loss, "-", color="#2196F3", linewidth=1.3, alpha=0.9)
ax1.plot(rs1_steps, rs1_loss, "-.", color="#FF9800", label="Reverse (hard→easy)", linewidth=1.3, alpha=0.9)
ax1.plot(rs2_steps, rs2_loss, "-.", color="#FF9800", linewidth=1.3, alpha=0.9)
ax1.plot(bl64_steps, bl64_loss, "--", color="#4CAF50", label="Baseline r=64", linewidth=1.3, alpha=0.9)
ax1.plot(bl8_steps, bl8_loss, ":", color="#9C27B0", label="Baseline r=8", linewidth=1.3, alpha=0.9)
# Stage transition marker
ax1.axvline(x=4000, color="gray", linewidth=0.7, linestyle="--", alpha=0.5)
...
# --- Margin ---
ax2.plot(s1_steps, s1_margin, "-", color="#2196F3", label="AC-DPO (easy→hard)", linewidth=1.3, alpha=0.9)
ax2.plot(s2_steps, s2_margin, "-", color="#2196F3", linewidth=1.3, alpha=0.9)
ax2.plot(rs1_steps, rs1_margin, "-.", color="#FF9800", label="Reverse (hard→easy)", linewidth=1.3, alpha=0.9)
ax2.plot(rs2_steps, rs2_margin, "-.", color="#FF9800", linewidth=1.3, alpha=0.9)
ax2.plot(bl64_steps, bl64_margin, "--", color="#4CAF50", label="Baseline r=64", linewidth=1.3, alpha=0.9)
ax2.plot(bl8_steps, bl8_margin, ":", color="#9C27B0", label="Baseline r=8", linewidth=1.3, alpha=0.9)
ax2.axhline(y=0, color="gray", linewidth=0.5, linestyle="--")
ax2.axvline(x=4000, color="gray", linewidth=0.7, linestyle="--", alpha=0.5)
