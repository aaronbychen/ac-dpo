"""Ablation: Fixed Low-Rank Baseline (r=8 on all data).

Same as baseline_r64 but with r=8 throughout.
Tests whether low capacity alone is sufficient, or if expansion is needed.
"""
import os
import json
import time
...
print("1. Initializing Baseline r=8 Model and Tokenizer...")
...
print("\nBaseline r=8 Training Completed! Saving Final Model...")
