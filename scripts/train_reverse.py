"""Ablation: Reverse Curriculum DPO (Hard→Easy, r=8→r=64).

Same two-stage capacity expansion as AC-DPO, but with reversed data order:
Stage 1 trains on HARD data with r=8, Stage 2 trains on EASY data with r=64.
This tests whether curriculum ordering (easy→hard) matters.
"""
import os
import json
import time
...
# REVERSED: Stage 1 = hard, Stage 2 = easy
